          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-4">
                By accessing and using Talaash by Jaayvee ("the Service"), you accept and agree to be 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-4">
                Permission is granted to temporarily download one copy of the materials on Talaash's 
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-white mb-4">3. Event Registration and Booking</h2>
              <p className="text-gray-300 mb-4">
                When you register for events through our platform:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-4 space-y-2">
                <li>You must provide accurate and complete information</li>
                <li>You are responsible for maintaining the confidentiality of your account</li>
                <li>Event details, dates, and venues are subject to change</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-4">
                ...
                the exclusive property of Talaash by Jaayvee and its licensors. The Service is 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-4">
                ...
                permitted by law, Talaash by Jaayvee excludes all representations, warranties, 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-4">
                In no event shall Talaash by Jaayvee, nor its directors, employees, partners, agents, 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-4">
                ...
                arising from these terms will be subject to the exclusive jurisdiction of the courts 
